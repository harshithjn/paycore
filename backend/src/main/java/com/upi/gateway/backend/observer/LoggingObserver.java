...
/**
 * Concrete Observer for Logging Callback Activities
 * Handles comprehensive logging of all callback-related activities
 */
@Component
    ...
    private void logCallbackAttempt(Transaction transaction) {
        try {
            CallbackLog logEntry = CallbackLog.builder()
                ...
                .callbackUrl("INTERNAL_LOG") // Indicates this is an internal log entry
                .responseCode(200)
