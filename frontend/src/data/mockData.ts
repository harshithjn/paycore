...
export const mockTransactions: Transaction[] = [
  {
    ...
    status: 'success',
    paymentMethod: 'UPI',
    merchantTransactionId: 'MERCH_TXN_001',
  ...
  },
  {
    ...
    status: 'failed',
    paymentMethod: 'UPI',
    merchantTransactionId: 'MERCH_TXN_002',
  ...
  },
  {
    ...
    status: 'processing',
    paymentMethod: 'UPI',
    merchantTransactionId: 'MERCH_TXN_003',
  ...
  },
  {
    ...
    status: 'success',
    paymentMethod: 'UPI',
    merchantTransactionId: 'MERCH_TXN_004',
    customerEmail: 'client@example.com',
    customerPhone: '+91-9876543213',
    createdAt: '2024-03-14T16:20:00Z',
    updatedAt: '2024-03-14T16:21:00Z',
    callbackSent: true,
  ...
  },
  {
    ...
    status: 'pending',
    paymentMethod: 'UPI',
    merchantTransactionId: 'MERCH_TXN_005',
